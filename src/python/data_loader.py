...
def extract_all_vcgs_for_beat(patient_code, beat_idx, isoelectric_samples, percentile, preproc_dir:str, params_dir:str, dataset_dir:str):
    """
    ...
    """
    try:
        beat_start_idx, rpeak, beat_end_idx, m_detrend = get_R_preproc(patient_code, beat_idx, preproc_dir)
        ...
        # Parametri e FMM
        params_per_lead = get_R_params(patient_code, beat_idx, params_dir)
