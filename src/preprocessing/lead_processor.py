...
class LeadProcessor:
    """
    Classe per il preprocessing di una singola derivazione di ECG.
    """
    ...
    def preprocess_single_lead(self):
        ...
        # Rimozione della baseline (componente a bassa frequenza)
        ...
        # Rilevamento iniziale dei picchi di R
        try:
        ...
        # Gestione segnali anomali tramite median-clipping e re-fitting LOESS
        ...
        # Passo 1: Filtraggio locale di RR e ampiezza
    ...
    def filter_artifacts(self, global_peaks, global_segments):
        """
        Raffina le annotazioni basandosi sul set mediano globale.
        """
