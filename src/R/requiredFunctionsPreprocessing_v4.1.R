...
if( sum(data!=0)>0.75*length(data)){
	...
	#ANALITICALLY
	dd<-data
	# [FASE 1.1] Rimozione Baseline: Smoothing polinomiale locale (LOESS)
	...
	# [FASE 1.2] Identificazione QRS: Estrazione picchi R assimilabile al Pan-Tompkins (usa libreria rsleep)
